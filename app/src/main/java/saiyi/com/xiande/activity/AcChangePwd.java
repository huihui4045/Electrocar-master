 ...
 * 修改密码
 */
public class AcChangePwd extends BaseActivity implements View.OnClickListener {
                ...
                Http.getAuthCode(mEtPhone.getText().toString(), new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        switch (msg.what) {
                            case 1://成功
                                time.start();
                                Toast.makeText(AcChangePwd.this, "获取验证码成功", Toast.LENGTH_SHORT).show();
                                break;
                            case 0://失败
                                Toast.makeText(AcChangePwd.this, "获取验证码失败", Toast.LENGTH_SHORT).show();
                                break;
                        }
                    }
                });
            ...
            case R.id.btnOK:
                ...
                Http.editPwd(mEtUser.getText().toString(), mEtPhone.getText().toString(), mEtPwd.getText().toString(), mEtVerify.getText().toString(), new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        switch (msg.what) {
                            case 1://成功
                                Toast.makeText(AcChangePwd.this, "修改成功", Toast.LENGTH_SHORT).show();
                                finish();
                                break;
                            case 0://失败
                                Toast.makeText(AcChangePwd.this, "修改失败", Toast.LENGTH_SHORT).show();
                                break;
                            case 3://验证码过期
                                Toast.makeText(AcChangePwd.this, "修改失败-验证码过期", Toast.LENGTH_SHORT).show();
                                break;
                        }
                    }
                });
